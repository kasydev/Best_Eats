    ...
    <div className="max-w-[1640px] mx-auto p-4 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative hover:scale-105 duration-300">
        ...
        <img
          ...
          src="https://images.pexels.com/photos/7438505/pexels-photo-7438505.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="/"
        />
      </div>
      <div className="rounded-xl relative hover:scale-105 duration-300">
      ...
      <div className="rounded-xl relative hover:scale-105 duration-300">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.pexels.com/photos/1474930/pexels-photo-1474930.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="/"
        />
      </div>
    </div>
